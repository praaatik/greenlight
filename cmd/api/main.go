...
// TODO this will be generated automatically at build time later on
const version = "1.0.0"
...
// hold the dependencies of the HTTP handlers, helpers, middlewares
...
func main() {
	...
	defer db.Close()
	logger.Printf("databse connection established")
